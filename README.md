...
1. X _As_ an anonymous user, _I want_ to create an account _so that_ I could login.
2. X _As_ an anonymous user, _I want_ to login _so that_ I could access authenticate actions.
3. X _As_ an authenticate user, _I want_ to create a group _so that_ I could be a group admin.
...
6. X _As_ an authenticate user, _I want_ to get a list of all groups _so that_ I could ask to join one of them.
